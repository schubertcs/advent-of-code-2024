...
public class Task2 {
    ...
    public void run() throws URISyntaxException, IOException {
        ...
        try (final Stream<String> lines = Files.lines(path)) {
            ...
            for (final Node startingNode : startingNodes) {
                final List<Node> finalNodesReached = determineFinalNodesReached(startingNode);
    ...
    private List<Node> determineFinalNodesReached(final Node startingNode) {
        final List<Node> finalNodesReached = new ArrayList<>();
